...
class CountryListPicker extends StatefulWidget {
  ...
  const CountryListPicker({
    ...
    this.flagSize = const Size(16, 16),
...
class _CountryListPickerState extends State<CountryListPicker> {
  ...
  Widget build(BuildContext context) {
    InputThemeData inputThemeText=InputThemeData(hintStyle:  getMediumStyle(
        color: Theme.of(context).colorScheme.secondary, fontSize: 14.spMin),style:  getMediumStyle(
              ...
              decoration: BoxDecoration(
                  ...
                  border: (widget.inputTheme.border == InputBorder.none || widget.isShowInputField == false) &&
                      ...
                      ? widget.border.isOutline
                          ...
                          : inputOnFocus == true || widget.isShowInputField == false
                              ? Border(
                                  bottom: BorderSide(color: Theme.of(context).colorScheme.secondaryContainer, width: widget.border.borderSide.width))
                              : Border(bottom: BorderSide(color:Theme.of(context).colorScheme.secondaryContainer, width: 1))
                      : null),
  ...
  Future<void> _onTapEvent(BuildContext context) async {
    final Country? result =await showModalBottomSheet(
      context: context,
  ...
  Row _buildMainPart(Country country) {
    return Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, children: [
      ...
      if (widget.isShowFlag == true)
        Flexible(
            child: Image.asset("assets/flags/${country.iso_3166_1_alpha2.toLowerCase()}.png", fit: BoxFit.fill, height: widget.flagSize.height, width: widget.flagSize.width)),
      //code
